...
const PropertyCard = ({ 
  ...
  return (
    <Card 
      className="overflow-hidden shadow-card hover:shadow-float transition-all duration-300 cursor-pointer w-full max-w-sm sm:max-w-md md:max-w-lg mx-auto"
      onClick={onCardClick}
    >
      <div className="relative">
        ...
        <button 
          ...
          className="absolute top-2 sm:top-3 right-2 sm:right-3 p-1.5 sm:p-2 bg-card/80 backdrop-blur-sm rounded-full hover:bg-card transition-colors"
        >
          <Heart 
            size={14} 
        ...
        {coordinates && (
          <button
            ...
            className="absolute top-2 sm:top-3 right-10 sm:right-12 p-1.5 sm:p-2 bg-card/80 backdrop-blur-sm rounded-full hover:bg-card transition-colors"
          >
      ...
      <CardContent className="p-3 sm:p-4">
        <h3 className="font-semibold text-sm sm:text-lg mb-1 line-clamp-2">{title}</h3>
